    ...
    <div class="container">
        <main class="form-signin w-100 m-auto p-5 textPurple">
            <form method="POST" action="{{ route('login') }}">
                ...
                <button class="btn-dev w-100 py-2" type="submit">Login</button>
            </form>
            <div class="mt-4">
                <p class="text-center"><a href="{{ route('register') }}" class="textPurple" style="text-decoration: none">Registrar-se?</a></p>
            </div>
